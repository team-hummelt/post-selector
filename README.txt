 ...
 * Custom gallery settings and templates
 * Show posts as news
 * countless output options

* 3rd Party
  Activation information will be transmitted to `https://www.hummelt-werbeagentur.de`. No personal data will be sent or stored.
...
* All functions renewed and optimized
* The plugin version 2 can be installed parallel to version 1
...
== Upgrade Notice ==
### 2.0.0 ###
Plugin core completely revised. All functions renewed and optimized. The plugin version 2 can be installed parallel to version 1.