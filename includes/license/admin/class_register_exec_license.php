...
class Register_Exec_License {
	 ...
	 * @return static
	 */
	public static function instance( string $basename, string $version, object $config, Post_Selector $main, string $plugin_dir ): self {
	 ...
	 */
	public function __construct( string $basename, string $version, object $config, Post_Selector $main, string $plugin_dir ) {
